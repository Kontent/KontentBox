...
{
	function onContentPrepare(&$row, &$params)
	{
		// Add the mootools behavior.
		JHTML::_('behavior.mootools');
		JHTML::stylesheet('kontentbox.css', 'plugins/content/kontentbox/ronbox/');
		JHTML::script('kontentbox.js', 'plugins/content/kontentbox/ronbox/');
	}
}